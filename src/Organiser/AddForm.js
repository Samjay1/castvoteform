...
class Forms extends React.Component{
    constructor(){
        ...
        this.state={ 
            ...
            resValue1:null,resValue2:null,resValue3:null,resValue4:null,resValue5:null,resValue6:null,resValue7:null,resValue8:null,resValue9:null,
    ...
    submitForm = ()=>{
        ...
        if(this.state.title?.length===0 || this.state.question1?.length===0){
            ...
            axios.post(`${this.state.BASE_URL}/addform`, formdata)
            .then((response)=>{
                    ...
                    <div className='grid lg:grid-cols-2 gap-2 border p-5 rounded-xl'>
                        ...
                        {/* <div className='bg-blue-50 p-5 rounded-xl'>
                            <div className='flex justify-between font-bold'>
                                ...
                                <div className='space-x-1'>
                                    <label>Add</label> <input type="checkbox" name='checkState10' checked={this.state.checkState10} onChange={this.onChecking}/>
                                </div>
                            </div>
                            <Text question={'Enter the question'} questionName={'q10'} OnChangeValue={this.onChangeValue}  myValue={this.state.question10}/>
                            <Dropdown question={'Select Response type'} questionName={'resp10'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                        </div> */}
                    </div>
