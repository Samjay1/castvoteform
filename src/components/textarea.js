const textarea = ({defaultValue,onValueChange,errorState,question,questionName})=>{
                ...
                <div className="answers">
                    <div className="answer-item">
                        <label className="w-75">
                            <textarea name={questionName} onChange={onValueChange} value={defaultValue} type="text" className="border-b border-r  focus:outline-none lg:w-1/2 w-full focus:border-black text-input rounded-b py-2 px-2 hover:bg-red-50"  placeholder="Type your response"></textarea>
                        </label>
                    </div>
                </div>
            </div>
