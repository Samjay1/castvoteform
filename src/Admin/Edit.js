        ...
        <>
            <div className="relative min-h-screen md:flex">
                ...
                <main className="lg:mx-5 my-5 w-full px-5">
                    {/* <!-- BASIC PROFILE INFO --> */}
                    <p className="text-2xl font-bold text-gray-800">Update Nominee Form</p>
                    ...
                    <div className='text-center my-4'>
                        <button className='bg-blue-700 text-white rounded px-4 py-1 font-bold m-auto'>Update Form</button>
                    </div>
                </main>
           </div>
           <Footer/>
