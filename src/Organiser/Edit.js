        ...
        let getFormData = (form_id)=>{
            ...
            .then((response)=>{
                ...
                this.setState({
                    ...
                    question1:data.q1,question2:data.q2,question3:data.q3,question4:data.q4,question5:data.q5,question6:data.q6,question7:data.q7,question8:data.q8,question9:data.q9,question10:data.q10,
                    resType1:data.r1,resType2:data.r2,resType3:data.r3,resType4:data.r4,resType5:data.r5,resType6:data.r6,resType7:data.r7,resType8:data.r8,resType9:data.r9,resType10:data.r10,
                    resValue1:data.rv1,resValue2:data.rv2,resValue3:data.rv3,resValue4:data.rv4,resValue5:data.rv5,resValue6:data.rv6,resValue7:data.rv7,resValue8:data.rv8,resValue9:data.rv9,
                ...
                null}
                    ...
                    <div className='grid lg:grid-cols-2 gap-2 border p-5 rounded-xl'>
                        <div className='col-span-2 py-4'>
                             {/*     QUESTION FORMAT */}
                             <img className="h-80 w-full object-cover rounded-xl  shadow-lg" src={this.state.response?.banner_image? `http://localhost:7001/${this.state.response?.banner_image}` :"https://cdn.pixabay.com/photo/2016/11/13/12/52/kuala-lumpur-1820944_1280.jpg"} alt="" />
                             <div className='my-4'>
                       ...
                       <div className='bg-blue-50 p-5 rounded-xl'>
                        ...
                        <div className='bg-blue-50 p-5 rounded-xl'>
                            <div className='flex justify-between font-bold'>
                                ...
                                <div className='space-x-1'>
                                    <label>Add</label> <input type="checkbox" checked={this.state.question10?true:false} readOnly/>
                                </div>
                            </div>
                            <Text question={'Enter the question'} questionName={'q10'} OnChangeValue={this.onChangeValue} myValue={this.state.question10}/>
                            <Dropdown question={`Select Response type: ${this.state.resType10?this.state.resType10:'' }`} questionName={'resp10'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                            {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            {/* {this.state.resType1==='DROPDOWN' || this.state.resType1==='RADIO' || this.state.resType1==='CHECKBOX'? 
                            <div>
